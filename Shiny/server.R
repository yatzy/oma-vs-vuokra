...
#                                )
      ...
      output$tuottokuva <- renderPlot({
         plot(omistusasunto_matriisi()[,'Vuosi'] , omistusasunto_matriisi()[,'Sijoituksen_arvo'] 
              , type='l', col='red',main='Sijoituksen tuotto')   
         points(omistusasunto_matriisi()[,'Vuosi'], omistusasunto_matriisi()[,'Vuokra_sijoituksen_arvo']
                , type='l', col='blue') # , 
